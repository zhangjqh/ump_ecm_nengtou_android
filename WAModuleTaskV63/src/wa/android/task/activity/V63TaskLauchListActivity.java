...
public class V63TaskLauchListActivity extends BaseActivity implements OnActionListener{
...
//		rightBtn.setVisibility(View.GONE);		
		...
		taskExListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				intent.setClass(V63TaskLauchListActivity.this, V63TaskDetailActivity.class);
