...
function nc$bs$oa$oama$ecm$msg_CreateMessageEntity$get_msgtitle(){
	return this.field('msgtitle');
}
function nc$bs$oa$oama$ecm$msg_CreateMessageEntity$set_msgtitle(value){
...
nc.bs.oa.oama.ecm.msg_CreateMessageEntity.prototype = {
    ...
    get_msgtitle : nc$bs$oa$oama$ecm$msg_CreateMessageEntity$get_msgtitle,
    set_msgtitle : nc$bs$oa$oama$ecm$msg_CreateMessageEntity$get_msgtitle
}
