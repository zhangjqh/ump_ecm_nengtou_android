Type.registerNamespace('nc.bs.oa.oama.ecm.responserefController');
nc.bs.oa.oama.ecm.responserefController = function() {

}
function nc$bs$oa$oama$ecm$responserefController$initialize(ctx){
...
function nc$bs$oa$oama$ecm$responserefController$refload(ctx){
   //alert(jsonToString(ctx.params()));
     var checkrows = stringToJSON(ctx.params()["checkrows"]);
     if(checkrows != ""){
...
function nc$bs$oa$oama$ecm$responserefController$serchkeyword(ctx){
...
function nc$bs$oa$oama$ecm$responserefController$getnextpage(ctx){
...
function nc$bs$oa$oama$ecm$responserefController$okbtn(ctx){
	...
	var serviceparams = {
		              ...
		              "isDataCollect" : "true",
		              "result" : {
		              	"assistpersonlist" : staffstr,
		              	"assistantstructlistcache" : templist
		              }
	               };
    var serviceparams = $jsonToString(serviceparams);              
	UM_NativeCall.callService(serviceType,serviceparams); 
}
function nc$bs$oa$oama$ecm$responserefController$onEmptyClick(ctx){
...
function nc$bs$oa$oama$ecm$responserefController$searchcallback(ctx){
...
function getCache(){
	return eval($cache.readFile("OAPOCROWSELECTED")) || [];
}
function updateCache(value){
	$cache.writeFile("OAPOCROWSELECTED", value || []);
}
nc.bs.oa.oama.ecm.responserefController.prototype = {
    initialize : nc$bs$oa$oama$ecm$responserefController$initialize,
    refload : nc$bs$oa$oama$ecm$responserefController$refload,
    serchkeyword : nc$bs$oa$oama$ecm$responserefController$serchkeyword,
    getnextpage : nc$bs$oa$oama$ecm$responserefController$getnextpage,
    okbtn : nc$bs$oa$oama$ecm$responserefController$okbtn,
    onEmptyClick : nc$bs$oa$oama$ecm$responserefController$onEmptyClick,
    searchcallback : nc$bs$oa$oama$ecm$responserefController$searchcallback
};
nc.bs.oa.oama.ecm.responserefController.registerClass('nc.bs.oa.oama.ecm.responserefController');
