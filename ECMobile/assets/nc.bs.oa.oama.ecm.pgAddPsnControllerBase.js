Type.registerNamespace('nc.bs.oa.oama.ecm.pgAddPsnControllerBase');
nc.bs.oa.oama.ecm.pgAddPsnControllerBase = function() {
    //Step 1：inherit the base class
    nc.bs.oa.oama.ecm.pgAddPsnControllerBase.initializeBase(this);
    ...
    if(nc.bs.oa.oama.ecm.pgAddPsnController){
        this._userController = new nc.bs.oa.oama.ecm.pgAddPsnController();
    }else{
        alert("please check the js file[nc.bs.oa.oama.ecm.pgAddPsnController.js], it probably has some syntax wrong.");
        //return;
    }
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$tipsOnload(json){
    try{
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$doSearch(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$save(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
        ...
        if(this._userController.initialize)
            this._userController.initialize();
        if(this._userController.save){
            this._userController.save($context);
        }else{
            alert("找不到方法[save]/n，请检查JSController代码是否有语法错误，导致JS未能正确加载");
        }
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonUnload(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$cancel(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
        ...
        if(this._userController.initialize)
            this._userController.initialize();
        if(this._userController.cancel){
            this._userController.cancel($context);
        }else{
            alert("找不到方法[cancel]/n，请检查JSController代码是否有语法错误，导致JS未能正确加载");
        }
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonComplete(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$setChecked(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$cancelTest(json){
    try{
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonDataBinding(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$getNextSearch(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$searchCallback(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonInit(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonLoad(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
function nc$bs$oa$oama$ecm$pgAddPsnControllerBase$setTips(json){
    try{
    	//when every action begin,  json-->$context
    	this._context = _$um$CRUD$load(this._context, json, this._entity);
    	if(this._context){
...
nc.bs.oa.oama.ecm.pgAddPsnControllerBase.prototype = {
    tipsOnload : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$tipsOnload,
    doSearch : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$doSearch,
    save : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$save,
    UMonUnload : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonUnload,
    cancel : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$cancel,
    UMonComplete : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonComplete,
    setChecked : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$setChecked,
    cancelTest : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$cancelTest,
    UMonDataBinding : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonDataBinding,
    ...
    UMonInit : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonInit,
    UMonLoad : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$UMonLoad,
    setTips : nc$bs$oa$oama$ecm$pgAddPsnControllerBase$setTips
};
nc.bs.oa.oama.ecm.pgAddPsnControllerBase.registerClass('nc.bs.oa.oama.ecm.pgAddPsnControllerBase',UMP.UI.Mvc.Controller);
