...
nc.bs.oa.oama.ecm.reportlist = function(id, entity, json) {
    //Step 1：call base method and initialize context object
    nc.bs.oa.oama.ecm.reportlist.initializeBase(this,[id, entity, json]);
    
}
function nc$bs$oa$oama$ecm$reportlist$get_listid(){
    return this.get('listid');
}
function nc$bs$oa$oama$ecm$reportlist$set_listid(value){
    return this.set('listid',value);
}
function nc$bs$oa$oama$ecm$reportlist$get_reporthistorylist(){
    return this.get('reporthistorylist');
}
function nc$bs$oa$oama$ecm$reportlist$set_reporthistorylist(value){
    return this.set('reporthistorylist',value);
}
nc.bs.oa.oama.ecm.reportlist.prototype = {
    get_listid : nc$bs$oa$oama$ecm$reportlist$get_listid,
    set_listid : nc$bs$oa$oama$ecm$reportlist$get_listid,
    get_reporthistorylist : nc$bs$oa$oama$ecm$reportlist$get_reporthistorylist,
    set_reporthistorylist : nc$bs$oa$oama$ecm$reportlist$get_reporthistorylist
}
nc.bs.oa.oama.ecm.reportlist.registerClass('nc.bs.oa.oama.ecm.reportlist',UMP.UI.Mvc.Context);
...
function nc$bs$oa$oama$ecm$reporthistorylist$get_approvalmsg(){
    return this.get('approvalmsg');
}
function nc$bs$oa$oama$ecm$reporthistorylist$set_approvalmsg(value){
    return this.set('approvalmsg',value);
}
function nc$bs$oa$oama$ecm$reporthistorylist$get_reportstate(){
    return this.get('reportstate');
}
function nc$bs$oa$oama$ecm$reporthistorylist$set_reportstate(value){
    return this.set('reportstate',value);
}
function nc$bs$oa$oama$ecm$reporthistorylist$get_repstatecode(){
    return this.get('repstatecode');
}
function nc$bs$oa$oama$ecm$reporthistorylist$set_repstatecode(value){
    return this.set('repstatecode',value);
}
function nc$bs$oa$oama$ecm$reporthistorylist$get_time(){
    return this.get('time');
}
function nc$bs$oa$oama$ecm$reporthistorylist$set_time(value){
    return this.set('time',value);
}
function nc$bs$oa$oama$ecm$reporthistorylist$get_relatedname(){
    return this.get('relatedname');
}
function nc$bs$oa$oama$ecm$reporthistorylist$set_relatedname(value){
    return this.set('relatedname',value);
}
function nc$bs$oa$oama$ecm$reporthistorylist$get_taskstate(){
    return this.get('taskstate');
}
function nc$bs$oa$oama$ecm$reporthistorylist$set_taskstate(value){
    return this.set('taskstate',value);
}
function nc$bs$oa$oama$ecm$reporthistorylist$get_taskschedule(){
    return this.get('taskschedule');
}
function nc$bs$oa$oama$ecm$reporthistorylist$set_taskschedule(value){
    return this.set('taskschedule',value);
}
function nc$bs$oa$oama$ecm$reporthistorylist$get_completion(){
    return this.get('completion');
}
function nc$bs$oa$oama$ecm$reporthistorylist$set_completion(value){
    return this.set('completion',value);
}
function nc$bs$oa$oama$ecm$reporthistorylist$get_attachmentlist(){
    return this.get('attachmentlist');
}
function nc$bs$oa$oama$ecm$reporthistorylist$set_attachmentlist(value){
    return this.set('attachmentlist',value);
}
nc.bs.oa.oama.ecm.reporthistorylist.prototype = {
    get_approvalmsg : nc$bs$oa$oama$ecm$reporthistorylist$get_approvalmsg,
    set_approvalmsg : nc$bs$oa$oama$ecm$reporthistorylist$get_approvalmsg,
    get_reportstate : nc$bs$oa$oama$ecm$reporthistorylist$get_reportstate,
    set_reportstate : nc$bs$oa$oama$ecm$reporthistorylist$get_reportstate,
    get_repstatecode : nc$bs$oa$oama$ecm$reporthistorylist$get_repstatecode,
    set_repstatecode : nc$bs$oa$oama$ecm$reporthistorylist$get_repstatecode,
    get_time : nc$bs$oa$oama$ecm$reporthistorylist$get_time,
    set_time : nc$bs$oa$oama$ecm$reporthistorylist$get_time,
    get_relatedname : nc$bs$oa$oama$ecm$reporthistorylist$get_relatedname,
    set_relatedname : nc$bs$oa$oama$ecm$reporthistorylist$get_relatedname,
    get_taskstate : nc$bs$oa$oama$ecm$reporthistorylist$get_taskstate,
    set_taskstate : nc$bs$oa$oama$ecm$reporthistorylist$get_taskstate,
    get_taskschedule : nc$bs$oa$oama$ecm$reporthistorylist$get_taskschedule,
    set_taskschedule : nc$bs$oa$oama$ecm$reporthistorylist$get_taskschedule,
    get_completion : nc$bs$oa$oama$ecm$reporthistorylist$get_completion,
    set_completion : nc$bs$oa$oama$ecm$reporthistorylist$get_completion,
    get_attachmentlist : nc$bs$oa$oama$ecm$reporthistorylist$get_attachmentlist,
    set_attachmentlist : nc$bs$oa$oama$ecm$reporthistorylist$get_attachmentlist
}
