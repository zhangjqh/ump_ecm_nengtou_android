...
public class Scdu_addschedulerExtendActivity extends Scdu_addschedulerActivity {
  ...
  super.actionIsalldayChanged(control,args);
}
...
public void actionRemindTypeOnload(View control, UMEventArgs args) {
  super.actionRemindTypeOnload(control,args);
}
...
public void actionRemindTypeInit(View control, UMEventArgs args) {
  super.actionRemindTypeInit(control,args);
}
...
public void actionToRepeatRull(View control, UMEventArgs args) {
  super.actionToRepeatRull(control,args);
}
public void actionToRemindRull(View control, UMEventArgs args) {
  super.actionToRemindRull(control,args);
}
