...
public abstract class Ecm_SearchEGActivity extends UMWindowActivity {

	protected UMWindow SearchEG = null;
...
protected UMLabel listView_childWgt0_entName = null;
protected UMLabel listView_childWgt0_entNum = null;
protected UMLabel listView_childWgt0_entSpace = null;
protected UMImage listView_childWgt0_entImg = null;

	
	protected final static int ID_SEARCHEG = 1011773665;
protected final static int ID_BASEPANEL = 1584678539;
protected final static int ID_NAVPANEL = 1309844804;
protected final static int ID_NAVIGATORBAR = 839279180;
protected final static int ID_LEFTPANEL = 1331609814;
protected final static int ID_RETURNBTN = 791103645;
protected final static int ID_CENTERPANEL = 2121335916;
protected final static int ID_NAVLABEL = 2018111016;
protected final static int ID_RIGHTPANEL = 1699387578;
protected final static int ID_SEARCHBTN = 346479484;
protected final static int ID_NUMLABEL = 91342728;
protected final static int ID_TYPEPANEL = 434770152;
protected final static int ID_TOGGLEGROUP = 1183422420;
protected final static int ID_ORGBTN = 25009164;
protected final static int ID_ENTBTN = 1202273662;
protected final static int ID_GROUPBTN = 1866768781;
protected final static int ID_LISTBTN = 732038974;
protected final static int ID_BORDERPANEL = 254984411;
protected final static int ID_MAINPANEL = 1332515978;
protected final static int ID_LISTVIEW = 1173644158;
protected final static int ID_LISTVIEW_CHILDWGT0 = 353469307;
protected final static int ID_LISTVIEW_CHILDWGT0_ENTNAME = 433009461;
protected final static int ID_LISTVIEW_CHILDWGT0_ENTNUM = 561684401;
protected final static int ID_LISTVIEW_CHILDWGT0_ENTSPACE = 64503398;
protected final static int ID_LISTVIEW_CHILDWGT0_ENTIMG = 864079790;

	
	
	@Override
	public String getControllerName() {
		return "EcmSearchEGController";
	}
...
this.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("SearchEG",ID_SEARCHEG);
  ...
  idmap.put("listView_childWgt0_entName",ID_LISTVIEW_CHILDWGT0_ENTNAME);
  idmap.put("listView_childWgt0_entNum",ID_LISTVIEW_CHILDWGT0_ENTNUM);
  idmap.put("listView_childWgt0_entSpace",ID_LISTVIEW_CHILDWGT0_ENTSPACE);
  idmap.put("listView_childWgt0_entImg",ID_LISTVIEW_CHILDWGT0_ENTIMG);
    ...
    UMEventArgs args = new UMEventArgs(Ecm_SearchEGActivity.this);
...
listView_childWgt0_entName = (UMLabel)ThirdControl.createControl(new UMLabel(context),ID_LISTVIEW_CHILDWGT0_ENTNAME
,"bindfield","name"
,"halign","left"
,"weight","1"
,"width","0"
...
UMTextBinder listView_childWgt0_entName_binder = new UMTextBinder((IUMContextAccessor)context);
listView_childWgt0_entName_binder.setBindInfo(new BindInfo("name"));
listView_childWgt0_entName_binder.setControl(listView_childWgt0_entName);
binderGroup.addBinderToGroup(ID_LISTVIEW_CHILDWGT0_ENTNAME, listView_childWgt0_entName_binder);
listView_childWgt0.addView(listView_childWgt0_entName);
listView_childWgt0_entNum = (UMLabel)ThirdControl.createControl(new UMLabel(context),ID_LISTVIEW_CHILDWGT0_ENTNUM
,"content","Num"
,"bindfield","num"
,"halign","right"
,"height","fill"
...
UMTextBinder listView_childWgt0_entNum_binder = new UMTextBinder((IUMContextAccessor)context);
listView_childWgt0_entNum_binder.setBindInfo(new BindInfo("num"));
listView_childWgt0_entNum_binder.setControl(listView_childWgt0_entNum);
binderGroup.addBinderToGroup(ID_LISTVIEW_CHILDWGT0_ENTNUM, listView_childWgt0_entNum_binder);
listView_childWgt0.addView(listView_childWgt0_entNum);
listView_childWgt0_entSpace = (UMLabel)ThirdControl.createControl(new UMLabel(context),ID_LISTVIEW_CHILDWGT0_ENTSPACE
,"halign","center"
,"height","fill"
,"color","#000000"
,"layout-type","linear"
...
listView_childWgt0.addView(listView_childWgt0_entSpace);
listView_childWgt0_entImg = (UMImage)ThirdControl.createControl(new UMImage(context),ID_LISTVIEW_CHILDWGT0_ENTIMG
,"height","13"
,"layout-type","linear"
,"width","8"
,"scaletype","fitcenter"
...
listView_childWgt0.addView(listView_childWgt0_entImg);
...
SearchEG = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_SEARCHEG
,"halign","center"
,"height","fill"
,"layout","vbox"
,"width","fill"
,"context","Search"
,"controller","EcmSearchEGController"
,"namespace","nc.bs.oa.oama.ecm"
);
View basePanel = (View) getBasePanelView((UMActivity)context,binderGroup,configure);
SearchEG.addView(basePanel);

return (UMWindow)SearchEG;
}
