...
public class Info_columninfosExtendActivity extends Info_columninfosActivity {
  ...
  super.actionColumnInfoNextPage(control,args);
}
...
public void actionColumnInfoFirstPage(View control, UMEventArgs args) {
  super.actionColumnInfoFirstPage(control,args);
}
