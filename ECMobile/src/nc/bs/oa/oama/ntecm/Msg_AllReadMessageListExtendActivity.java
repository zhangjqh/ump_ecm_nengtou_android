...
public class Msg_AllReadMessageListExtendActivity extends Msg_AllReadMessageListActivity {
...
public void actionNewMessage(View control, UMEventArgs args) {
  super.actionNewMessage(control,args);
}
public void actionOnUpRefresh(View control, UMEventArgs args) {
  super.actionOnUpRefresh(control,args);
}
...
public void actionOpenUnReadMessageList(View control, UMEventArgs args) {
  super.actionOpenUnReadMessageList(control,args);
}
