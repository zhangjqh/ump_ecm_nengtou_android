...
public class Scdu_myschedulerExtendActivity extends Scdu_myschedulerActivity {
...
public void actionToMyScheduler(View control, UMEventArgs args) {
  super.actionToMyScheduler(control,args);
}
public void actionToAddScheduler(View control, UMEventArgs args) {
  super.actionToAddScheduler(control,args);
}
