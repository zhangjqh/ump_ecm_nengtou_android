...
public abstract class Scdu_remindrullrefActivity extends UMWindowActivity {

	protected UMWindow remindrullref = null;
...
protected UMLabel listview0_childWgt0_label0 = null;
	...
	protected final static int ID_REMINDRULLREF = 693622983;
protected final static int ID_VIEWPAGE0 = 1666572535;
protected final static int ID_NAVIGATORBAR0 = 860011020;
protected final static int ID_BUTTON1 = 380383262;
protected final static int ID_LABEL0 = 1675417557;
protected final static int ID_BUTTON0 = 2082320396;
protected final static int ID_LISTVIEW0 = 849648372;
protected final static int ID_LISTVIEW0_CHILDWGT0 = 1319433533;
protected final static int ID_LISTVIEW0_CHILDWGT0_LABEL0 = 108217845;

	
	
	@Override
	public String getControllerName() {
		return "remindrullrefController";
	}
...
this.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("remindrullref",ID_REMINDRULLREF);
  ...
  idmap.put("listview0_childWgt0_label0",ID_LISTVIEW0_CHILDWGT0_LABEL0);
	...
	public void onLoad() {
		...
		{ //viewPage0 - load
    UMEventArgs args = new UMEventArgs(Scdu_remindrullrefActivity.this);
...
binderGroup.addBinderToGroup(Common.genericId(), new PropertyBinder((IUMContextAccessor)context,label0,"content","#{res.scdu_oascheduler_0037}"));
...
listview0_childWgt0_label0_binder.setBindInfo(new BindInfo("desc"));
...
,"bindfield","alertRules"
,"height","0"
,"weight","1"
,"childindicator","remindrullrefRowWidget"
,"cursoraction","cursoronClickListRowalias"
,"layout-type","linear"
,"width","fill"
,"synccontext","alertRules"
,"background-image","listview.png"
);
context.createCursor("cursoronClickListRowalias", "alertRules");
UMListBinder listview0_binder = new UMListBinder((IUMContextAccessor)context);
listview0_binder.setBindInfo(new BindInfo("alertRules"));
...
remindrullref = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_REMINDRULLREF
,"halign","center"
,"height","fill"
,"layout","vbox"
,"width","fill"
,"context","alertRuleList"
,"controller","remindrullrefController"
,"namespace","nc.bs.oa.oama.ecm"
);
View viewPage0 = (View) getViewPage0View((UMActivity)context,binderGroup,configure);
remindrullref.addView(viewPage0);

return (UMWindow)remindrullref;
}
    ...
    args.put("result_arrayPath","alertRules");
  this.dataCollect();
...
public void actionLoad(View control, UMEventArgs args) {
    ...
    args.put("action","getAlertRuleList");
    args.put("isalldayswitch","#{plug.isalldayswitch}");
