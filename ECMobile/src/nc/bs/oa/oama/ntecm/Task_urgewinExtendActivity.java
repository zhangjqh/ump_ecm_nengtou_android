...
public class Task_urgewinExtendActivity extends Task_urgewinActivity {
  ...
  super.actionReturnback(control,args);
}
public void actionUrgeTask(View control, UMEventArgs args) {
  super.actionUrgeTask(control,args);
}
...
public void actionUrgeonload(View control, UMEventArgs args) {
  super.actionUrgeonload(control,args);
}
