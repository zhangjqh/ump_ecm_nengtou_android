...
public class Info_groupinfosExtendActivity extends Info_groupinfosActivity {
  ...
  super.actionGroupInfoDataLoad(control,args);
}
...
public void actionToColumnInfos(View control, UMEventArgs args) {
  super.actionToColumnInfos(control,args);
}
