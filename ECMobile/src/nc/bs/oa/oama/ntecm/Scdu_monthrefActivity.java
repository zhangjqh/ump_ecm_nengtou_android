...
public abstract class Scdu_monthrefActivity extends UMWindowActivity {

	protected UMWindow monthref = null;
...
protected UMLabel listview0_childWgt0_label0 = null;
	...
	protected final static int ID_MONTHREF = 1688546113;
protected final static int ID_VIEWPAGE0 = 977474012;
protected final static int ID_NAVIGATORBAR0 = 1996061298;
protected final static int ID_BUTTON1 = 671717232;
protected final static int ID_LABEL0 = 1480391918;
protected final static int ID_BUTTON0 = 772079018;
protected final static int ID_LISTVIEW0 = 2065115366;
protected final static int ID_LISTVIEW0_CHILDWGT0 = 76017533;
protected final static int ID_LISTVIEW0_CHILDWGT0_LABEL0 = 905892936;

	
	
	@Override
	public String getControllerName() {
		return "monthrefController";
	}
...
this.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("monthref",ID_MONTHREF);
  ...
  idmap.put("listview0_childWgt0_label0",ID_LISTVIEW0_CHILDWGT0_LABEL0);
	...
	public void onLoad() {
		...
		{ //viewPage0 - load
    UMEventArgs args = new UMEventArgs(Scdu_monthrefActivity.this);
...
binderGroup.addBinderToGroup(Common.genericId(), new PropertyBinder((IUMContextAccessor)context,label0,"content","#{res.scdu_oascheduler_0027}"));
...
,"height","0"
,"weight","1"
,"childindicator","monthrefRowWidget"
,"cursoraction","cursoronClickListRowalias"
,"layout-type","linear"
,"width","fill"
,"synccontext","monthrefs"
,"background-image","listview.png"
);
context.createCursor("cursoronClickListRowalias", "monthrefs");
UMListBinder listview0_binder = new UMListBinder((IUMContextAccessor)context);
listview0_binder.setBindInfo(new BindInfo("monthrefs"));
...
monthref = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_MONTHREF
,"halign","center"
,"height","fill"
,"layout","vbox"
,"width","fill"
,"context","repeatRull1"
,"controller","monthrefController"
,"namespace","nc.bs.oa.oama.ecm"
);
View viewPage0 = (View) getViewPage0View((UMActivity)context,binderGroup,configure);
monthref.addView(viewPage0);

return (UMWindow)monthref;
}
    ...
    args.put("result_arrayPath","monthrefs");
