...
public class Msg_ReadMessageListExtendActivity extends Msg_ReadMessageListActivity {
  ...
  super.actionOpenAllReadMessageList(control,args);
}
...
public void actionOnLoadReadMsgData(View control, UMEventArgs args) {
  super.actionOnLoadReadMsgData(control,args);
}
