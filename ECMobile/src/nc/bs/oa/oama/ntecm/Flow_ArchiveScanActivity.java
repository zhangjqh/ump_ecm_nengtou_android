...
public abstract class Flow_ArchiveScanActivity extends UMWindowActivity {

	protected UMWindow ArchiveScan = null;
...
protected UMLabel folderTxt = null;
...
protected XHorizontalLayout spaceInnerPanel2 = null;
	...
	protected final static int ID_ARCHIVESCAN = 54145225;
protected final static int ID_BASEPANEL = 167248886;
protected final static int ID_NAVPANEL = 749750575;
protected final static int ID_NAVIGATORBAR = 172771172;
protected final static int ID_LEFTPANEL = 1769094738;
protected final static int ID_RETURNBTN = 1198803516;
protected final static int ID_CENTERPANEL = 182121412;
protected final static int ID_NAVLABEL = 1365538946;
protected final static int ID_RIGHTPANEL = 1215251959;
protected final static int ID_MAINPANEL = 2004532543;
protected final static int ID_SPACEOUTPANEL = 921444477;
protected final static int ID_SPACEINNERPANEL = 1343456517;
protected final static int ID_FOLDERLABEL = 1572533580;
protected final static int ID_FOLDERPANEL = 1031762840;
protected final static int ID_FOLDERTXT = 1519811502;
protected final static int ID_SPACEOUTPANEL1 = 354719568;
protected final static int ID_SPACEINNERPANEL1 = 618273687;
protected final static int ID_AUTOPANEL = 1981908652;
protected final static int ID_AUTOLABEL = 895514228;
protected final static int ID_AUTOSPACELABEL = 1726915465;
protected final static int ID_SWITCHBTN = 1014474512;
protected final static int ID_PANEL0 = 873621992;
protected final static int ID_SPACEINNERPANEL2 = 806388698;

	
	
	@Override
	public String getControllerName() {
		return "ArchiveScanController";
	}
...
this.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("ArchiveScan",ID_ARCHIVESCAN);
  ...
  idmap.put("spaceInnerPanel2",ID_SPACEINNERPANEL2);
    ...
    UMEventArgs args = new UMEventArgs(Flow_ArchiveScanActivity.this);
...
folderTxt = (UMLabel)ThirdControl.createControl(new UMLabel(context),ID_FOLDERTXT
...
panel0.addView(spaceInnerPanel2);
...
ArchiveScan = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_ARCHIVESCAN
,"halign","center"
,"height","fill"
,"layout","vbox"
,"width","fill"
,"context","WorkDetail"
,"controller","ArchiveScanController"
,"namespace","nc.bs.oa.oama.ecm"
);
View basePanel = (View) getBasePanelView((UMActivity)context,binderGroup,configure);
ArchiveScan.addView(basePanel);

return (UMWindow)ArchiveScan;
}
