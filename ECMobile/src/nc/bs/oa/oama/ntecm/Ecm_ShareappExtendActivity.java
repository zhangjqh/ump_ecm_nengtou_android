...
public class Ecm_ShareappExtendActivity extends Ecm_ShareappActivity {
  ...
  super.actionCloseshare(control,args);
}
public void actionLoadset(View control, UMEventArgs args) {
  super.actionLoadset(control,args);
}
...
public void actionOpenurl(View control, UMEventArgs args) {
  super.actionOpenurl(control,args);
}
