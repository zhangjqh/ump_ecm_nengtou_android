...
public class Info_imgExtendActivity extends Info_imgActivity {
...
public void actionAfterLoadError(View control, UMEventArgs args) {
  super.actionAfterLoadError(control,args);
}
public void actionToClose(View control, UMEventArgs args) {
  super.actionToClose(control,args);
}
