...
public class Ecm_SearchExtendActivity extends Ecm_SearchActivity {
  ...
  super.actionLoadCondition(control,args);
}
...
public void actionSetCondition(View control, UMEventArgs args) {
  super.actionSetCondition(control,args);
}
public void actionOnSearchClick(View control, UMEventArgs args) {
  super.actionOnSearchClick(control,args);
}
