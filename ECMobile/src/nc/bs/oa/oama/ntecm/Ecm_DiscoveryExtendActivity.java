...
public class Ecm_DiscoveryExtendActivity extends Ecm_DiscoveryActivity {
...
public void actionInitDiscovery(View control, UMEventArgs args) {
  super.actionInitDiscovery(control,args);
}
