...
public abstract class BtnFieldViewAdapter<T> extends BaseAdapter {
	
	protected ArrayList<T> arrayList = null;
	protected BtnFieldView btnFieldView = null;
	protected Context context = null;
	public BtnFieldViewAdapter(Context context, ArrayList<T> arrayList){
