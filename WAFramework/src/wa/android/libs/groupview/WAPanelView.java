...
public class WAPanelView extends LinearLayout {
	...
	public static final int GROUP_MARGIN_LEFT = 0;
	public static final int GROUP_MARGIN_TOP = 4;
	public static final int GROUP_MARGIN_RIGHT = 0;
	public static final int GROUP_MARGIN_BOTTOM = 20;
	...
	public WAPanelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		initial();
	}
	 ...
	 * 由上到下，顺序添加组
	 */
	public void addGroup(WAGroupView group) {
