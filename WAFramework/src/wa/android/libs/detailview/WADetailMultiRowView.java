 ...
 * 
 */
public class WADetailMultiRowView extends WADetailRowView {
    ...
    public WADetailMultiRowView(Context context, View customView) {
    ...
    public WADetailMultiRowView(Context context, RowType type) {
        super(context, type);
        this.type = type;
        this.context = context;
        initial();
    ...
    private void confirm() {
        ...
        case NAME_C_VALUE: {
            ...
            cTextView.setHeight(ROW_HEIGHT);
