...
public class WADetailRowView extends LinearLayout {
	...
	private static final int inc_NAME_WIDTH_720 = 540;
	...
	public void setIconVisible(boolean ishide){
		if(iconView!=null){
			if(ishide){
	...
	private void initial() {
		...
		if (width >= 640) {
			...
			ROW_HEIGHT = (int) (ROW_HEIGHT*1.5);

			TEXT_SIZE_NAME = (int) (TEXT_SIZE_NAME*1.5);
			TEXT_SIZE_VALUE = (int) (TEXT_SIZE_VALUE*1.5);
			TEXT_SIZE_COLON = (int) (TEXT_SIZE_COLON*1.5);
			TEXT_SIZE_TEXT = (int) (TEXT_SIZE_TEXT*1.5);

			ROW_PADDING_LEFT = (int) (ROW_PADDING_LEFT*1.5);
			ROW_PADDING_TOP = (int) (ROW_PADDING_TOP*1.5);
			ROW_PADDING_RIGHT = (int) (ROW_PADDING_RIGHT*1.5);
			ROW_PADDING_BOTTOM = (int) (ROW_PADDING_BOTTOM*1.5);

			inc_INDEX_WIDTH = (int) (inc_INDEX_WIDTH*1.5);
			inc_NAME_WIDTH = (int) (inc_NAME_WIDTH*1.5);
			inc_INDEX_MARGIN_LEFT = (int) (inc_INDEX_MARGIN_LEFT*1.5);
			inc_NAME_MARGIN_LEFT = (int) (inc_NAME_MARGIN_LEFT*1.5);
			inc_ARRAY_MARGIN_LEFT = (int) (inc_ARRAY_MARGIN_LEFT*1.5);

			ncv_NAME_WIDTH = (int) (ncv_NAME_WIDTH*1.5);
			ncv_NAME_PADDING_LEFT = (int) (ncv_NAME_PADDING_LEFT*1.5);
			ncv_C_WIDTH = (int) (ncv_C_WIDTH*1.5);

			ncvi_NAME_WIDTH = (int) (ncvi_NAME_WIDTH*1.5);
			ncvi_VALUE_WIDTH = (int) (ncvi_VALUE_WIDTH*1.5);
			
			ROW_TEXT_PADDING_LEFT = (int) (ROW_TEXT_PADDING_LEFT*1.5);
			ROW_TEXT_PADDING_RIGHT = (int) (ROW_TEXT_PADDING_RIGHT*1.5);
			ROW_TEXT_PADDING_TOP = (int) (ROW_TEXT_PADDING_TOP*1.5);
			ROW_TEXT_PADDING_BOTTOM = (int) (ROW_TEXT_PADDING_BOTTOM*1.5);
			CONTENT_TEXT_SIZE = (int) (CONTENT_TEXT_SIZE*1.5);
		}
...
//			valueTextView.setEllipsize(TruncateAt.END);
			...
			nameTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, TEXT_SIZE_VALUE);
			nameTextView.setText(name);
			nameTextView.setSingleLine();
//			nameTextView.setTextColor(colorGray);
			nameTextView.setTextColor(Color.rgb(30, 64, 110));
