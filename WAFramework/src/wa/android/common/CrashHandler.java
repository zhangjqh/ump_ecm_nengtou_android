...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private void postReport(File file) {
		//将错误日志写到手机文件里
		File tempFile =  new File("/sdcard/ECMCrash/");
		if(!tempFile.exists()){
			tempFile.mkdirs();
		}
		byte[] byt = new byte[1024];
		File errorFile = new File("/sdcard/ECMCrash/"+"crasherror.txt");
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            ...
            fileName = "crash-" + String.valueOf(timestamp) + CRASH_REPORTER_EXTENSION;
